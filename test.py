...
from reader import get_specific_item_by_index, parseText
...
class Reader(App):
    def build(self):
        ...
        # book_content_trim = book_content[:1000] + "..."
        ...
        # else:
        #     text_to_display = book_content_trim

        # --- FIX 2: Use ScrollView for long text ---
        # 1. Create the main layout

        text_to_display = parseText('theKingInYellow.epub', 2, 1000)
        ...
        label = ScrollableLabel(
            ...
            font_size='48sp' # Reduced font size to make more text fit initially
        )
